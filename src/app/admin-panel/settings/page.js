...
export default function Settings() {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-4 sm:space-y-6">
      ...
      >
        ...
        <div className="relative">
          ...
          <p className="mt-1 text-orange-100 font-medium text-xs sm:text-sm max-w-xl">
            Manage your account preferences, security settings, and password.
          </p>
        </div>
      </motion.div>
      ...
      {/* Preferences */}
      <PortalCard header="Preferences" className="relative" padding="p-4 sm:p-6">
        <CommingSoon />
        <div className="grid gap-4 sm:gap-5 md:grid-cols-2">
          <div>
            <label className="mb-1.5 block text-xs sm:text-sm font-bold text-slate-800">
              Language
            </label>
            ...
            <select
              ...
              className="w-full rounded-xl sm:rounded-2xl border border-slate-200 px-4 py-2.5 text-xs sm:text-sm outline-none transition focus:border-yellow-400"
            >
          ...
          <div className="flex items-center justify-between rounded-xl sm:rounded-2xl border border-slate-200 p-3 sm:p-4">
            <div>
              <div className="flex items-center gap-2">
                <FaMoon className="text-yellow-600" />
                <h3 className="font-bold text-xs sm:text-sm text-slate-800">Dark Mode</h3>
              </div>
