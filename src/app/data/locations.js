export const locations = [
 ...
 whyChoose: [
  ...
  },
  {
    ...
    address: "Live Online Interactive Classes (Serving Zirakpur & Worldwide)",
    phone: "+91 98787 61488",
    hours: "Mon - Sat: 09:00 AM - 07:00 PM | Live Online Batches: 07:00 AM - 10:00 PM IST",
    ...
    offersVisits: false, // Set to true when physical center / in-person visits resume
    isOnlineOnly: true,  // Indicates all classes are currently conducted online
    // physicalAddress: "VIP Road, Zirakpur, Punjab 140603", // Preserved for future physical campus activation

    centralHub: [
       {
    title: "Online French Tutor Jobs",
    desc: "Explore opportunities to work as an online French tutor and connect with students looking to learn French remotely",
    ...
    features: [
      "Live Online Batches Dedicated to Zirakpur Learners",
      "1-on-1 Online Mentorship & Speaking Drills",
      "Small Batch Sizes (Max 6–8 Students)",
      "DELF, TEF & TCF Canada Exam Preparation",
    ],
    ...
    whyChoose: [
      {
        title: "TEF & TCF Canada Coaching Built Around Zirakpur's PR Aspirants",
        description:
          "With a growing number of Zirakpur residents applying for Canada PR, our batches are structured around exam timelines — mock tests, CLB score targets, and speaking drills tailored to TEF and TCF formats.",
      },
      {
        title: "Live Online Classes You Can Join From VIP Road, Dhakoli & Beyond",
        description:
          "No need to commute along the highway or through Zirakpur traffic — join live, interactive sessions from home with real-time teacher feedback and doubt-solving.",
      },
      {
        title: "Structured Study Plans for Exam-Date Deadlines",
        description:
          "If you have a TEF or TCF test date already booked, we build your batch schedule backward from that date so your prep stays on track instead of open-ended.",
      },
      {
        title: "Free Trial Class Before You Commit",
        description:
          "Sit in on a free trial session to see whether our teaching pace matches your timeline and current French level before enrolling.",
      },
    ],
    faq: [
      {
        question: "Are French classes for Zirakpur available online?",
        answer:
          "Yes! All our French classes for Zirakpur are currently conducted live online with interactive audio/video labs, small batches, and 1-on-1 options. Learners in VIP Road, Dhakoli, Baltana, and Peer Muchalla can join seamlessly from home.",
      },
      {
        question: "Is French easy to learn for beginners in Zirakpur?",
        answer:
          "French is considered one of the easier languages for English/Hindi speakers to pick up, especially with structured guidance. Our beginner-friendly A1 batches focus on building confidence in speaking and grammar step by step, so no prior knowledge is needed to start.",
      },
      {
        question: "Do you offer 1-on-1 online tutoring for Zirakpur students?",
        answer:
          "Yes, we provide personalized 1-on-1 live online French sessions for students in Zirakpur who prefer individual attention or targeted exam preparation for DELF, TEF, or TCF Canada.",
      },
      {
        question: "Can I join online French batches from Dera Bassi, Mohali, or Panchkula?",
        answer:
          "Yes, our live online batches serve learners across Zirakpur, Dera Bassi, Mohali, Panchkula, and surrounding Tricity areas.",
      },
      {
        question: "What are the French classes fees for Zirakpur learners?",
        answer:
          "Fees depend on the batch mode — live online group batches are the most affordable option, while 1-on-1 online mentorship is tailored for individual pace. Check our fee guide for a full breakdown.",
      },
      {
        question: "How long does it take to learn French from scratch?",
        answer:
          "Reaching basic conversational level (A1-A2) typically takes 2-4 months with consistent practice, while exam-ready proficiency for DELF B2 or TEF Canada usually takes 6-12 months depending on your starting level and study pace.",
      },
      {
        question: "Are physical center visits available in Zirakpur right now?",
        answer:
          "Physical center visits are currently paused while all classes are conducted live online. Physical visit options will be updated on this page once resumed.",
      },
    ],
    seo: {
      ...
      keywords: [
        "French classes Zirakpur",
        "French classes in Zirakpur",
        "French language classes near me",
        "French coaching near me",
        "Online French classes Zirakpur",
        "French institute Zirakpur",
        "Is French easy to learn",
        "Learn French Zirakpur",
      ],
    },
