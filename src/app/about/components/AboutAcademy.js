        ...
        <div className="grid items-center gap-14 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-10 grid grid-cols-2 gap-5 md:grid-cols-3">
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-5 hover:border-amber-200 transition">
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-5 hover:border-amber-200 transition">
                <FaChalkboardTeacher className="text-2xl text-amber-500" />
                <h3 className="mt-3 text-3xl font-bold text-slate-900">20+</h3>
                <p className="text-sm text-slate-500">Expert Teachers</p>
              </div>

              <div className="rounded-3xl border border-slate-200 bg-white p-5 hover:border-amber-200 transition col-span-2 md:col-span-1">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            ...
            {features.map((item) => (
              <div
                key={item.title}
                className="group rounded-[28px] border border-slate-200 bg-white p-6 transition-all hover:-translate-y-1 hover:border-amber-300 hover:shadow-xl"
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-amber-50 text-amber-500 text-2xl group-hover:bg-amber-100 transition">
                  {item.icon}
                </div>
