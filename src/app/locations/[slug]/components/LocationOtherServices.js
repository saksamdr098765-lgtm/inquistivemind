        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
              Specialized Educational Courses & Teaching Careers
            </h2>
            <p className="mt-2 text-sm text-slate-600">
              Explore our full range of French language coaching programs and teaching career opportunities.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((svc) => {
            ...
            return (
              <div
                key={svc.slug}
                className="group flex flex-col justify-between rounded-3xl border border-slate-200 bg-slate-50/50 p-6 shadow-xs transition-all hover:border-yellow-300 hover:bg-white hover:shadow-md"
              >
                <div>
                ...
                <div className="mt-6 pt-4 border-t border-slate-200/60">
                  ...
                  >
                    <span>{isTeacher ? "View Position" : "Explore Service"}</span>
